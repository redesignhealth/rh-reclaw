...
mcp: FastMCP[Any] = FastMCP(
    ...
    instructions=(
        ...
        "support two-party intra-owner task coordination (e.g. a "
        "Chief-of-Staff agent assigning work to, or receiving status back "
        "from, an EA agent). comms_whoami returns the authenticated "
        "caller's identity and scopes; comms_list_agents lists the board "
        "directory."
    ),

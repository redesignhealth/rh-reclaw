...
mcp: FastMCP[Any] = FastMCP(
    ...
    instructions=(
        ...
        "messages — no free text except the boundary_safe=False 'note' "
        "type. Register with comms_register, then use "
        "comms_start_conversation with conversation_type 'internal' (same "
        "verified owner, no ceremony), 'asymmetric' (owner sets intersect, "
        "invite/accept), or 'open' (unrestricted, invite/accept). "

...
# Fully-qualified tool names (post-mount prefix: ``<namespace>_<tool>``).
# Scope format: ``<service>:<verb>``. Verbs:
...
# tools). Empty today -- this provider registers no resources yet.
